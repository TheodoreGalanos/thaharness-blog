...
But what if we reread this incident from an AI security point of view? After all, as I have written before, building agentic environments and designing benchmarks is the same as building agent harnesses deployed in production. These things are entangled in reality, a knot. So security and a clear map of the attack surface belong in this work too.
...
The part of the harness this post proposes, in one figure:
