...
In engineering, the hard failure often comes when a model becomes plausibly generic, rather than incoherent.
...
The training run was intentionally small. It was meant to test whether the loop worked end to end on real benchmark tasks, rather than establish a production-quality adapter.
...
The adapter did more of the work. It read more, wrote more, submitted more, and failed with empty responses less often. I think what happened was workflow learning rather than general engineering competence.

The model became more likely to stay inside the environment (task world) long enough to produce something the verifier could judge.
