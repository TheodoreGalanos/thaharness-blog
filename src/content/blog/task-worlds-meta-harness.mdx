...
that world, run reviewer and governance layers, and materialise a recipe. It can
then bind execution evidence back through sandbox execution and use failures to
improve future world designs.
...
and ask the operation orchestrator for a plan. It can then apply governance,
materialise a comparison recipe, and import Harbor trial records back into a
`task_run` evidence object.
