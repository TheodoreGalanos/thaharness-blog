...
seoTitle: "Improving Agent Harnesses Through Feedback | The Third Axis"
author: "Theodoros Galanos"
category: "Engineering"
draft: false
pubDate: 2026-04-18
tags: ["harness-engineering", "autoresearch", "agentic-ai"]
---
...
If prompts-and-skills evolution can close a 15-point gap on Haiku, the next question is whether it can unstick a weaker executor given a stronger lever. Here, that lever is a sub-inference tool the agent can call when it hits a wall. Anthropic's playbook for their [advisor tool](https://platform.claude.com/docs/en/agents-and-tools/tool-use/advisor-tool) is clean — call at the start, call before declaring done, call when stuck. Does evolution discover that pattern on its own? And does advisor access let GPT-4.1-mini close the gap to Haiku?
